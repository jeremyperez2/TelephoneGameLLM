...
# Run the experiment with different temperatures
for temperature in 0 0.4 1.2 1.6
do
    SUBDIR="Results/"$model_name"_Temp"$temperature"/"$prompt"/"$story"/"seed$seed
    echo "Temperature:"$temperature
    python -u main_simulation.py \
        --n_agents $n_agents \
